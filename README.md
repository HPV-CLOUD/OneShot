...
**Getting OneShot**
 ```
 cd ~
 wget https://raw.githubusercontent.com/HPV-CLOUD/OneShot/master/oneshot.py
 ```
Optional: getting a list of vulnerable to pixie dust devices for highlighting in scan results:
 ```
 wget https://raw.githubusercontent.com/HPV-CLOUD/OneShot/master/vulnwsc.txt
 ```
## Arch Linux
**Installing requirements**
 ```
 ...
 **Getting OneShot**
 ```
 sudo wget https://raw.githubusercontent.com/HPV-CLOUD/OneShot/master/oneshot.py
 ```
Optional: getting a list of vulnerable to pixie dust devices for highlighting in scan results:
 ```
 sudo wget https://raw.githubusercontent.com/HPV-CLOUD/OneShot/master/vulnwsc.txt
 ```
...
#### Using installer
 ```
 curl -sSf https://raw.githubusercontent.com/HPV-CLOUD/OneShot/master/auto_install.sh | bash
 ```
#### Manually
**Installing requirements**
 ```
...
**Getting OneShot**
 ```
 git clone --depth 1 https://github.com/HPV-CLOUD/OneShot OneShot
 ```
#### Running
 ```
